...
import NoteView from '~/components/features/note-view/index.vue'
...
useSeoMeta({
  title: computed(() => filePath.value ? `${filePath.value} - Nuxt Obsidian Vault` : 'Notes - Nuxt Obsidian Vault'),
